...
public class AcelerometroFragment extends Fragment implements SensorEventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        diresao2 = view.findViewById(R.id.diresao2);
...
//        Log.e("teste", "X: " + sensorEvent.values[0] + " Y: " + sensorEvent.values[1] + " Z: " + sensorEvent.values[2]);
        ...
        if (yChange > 2) {
            direcao[1] = "DOWN";
            diresao2.setImageResource(R.drawable.setadown);
        } else if (yChange < -2) {
            direcao[1] = "UP";
            diresao2.setImageResource(R.drawable.setaup);
        }
